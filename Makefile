target=v4l2_cam
INCLUDE=-I./include -I./lib/include -I./include/liveMedia -I./include/BasicUsageEnvironment -I./include/groupsock -I./include/UsageEnvironment
...
JOBS=32
LIBS=  -lpthread -L./lib -lx264 -lliveMedia -lgroupsock -lBasicUsageEnvironment -lUsageEnvironment 
CPPFLAGS=-std=c++11
